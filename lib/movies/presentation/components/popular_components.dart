...
import 'package:payment_app/movies/presentation/screens/popular_details_screen.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const PopularDetailsScreen(),));
                        },
                        child: ClipRRect(
                          borderRadius:
